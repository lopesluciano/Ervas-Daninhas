...
input_dir = '/home/luciano/Documents2/sugar-beets-2016-DatasetNinja/ds/img'
output_dir = '/home/luciano/Documents2/Beetroots/images'
...
for filename in os.listdir(input_dir):
    if filename.endswith(".png"):
        ...
        # Salvar a máscara de culturas
        output_path = os.path.join(output_dir, f'crop_{filename}')
        cv2.imwrite(output_path, crop_original_mask)
